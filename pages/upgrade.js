  ...
  return (
    <div style={{ textAlign: 'center', padding: '60px 20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <p style={{ fontSize: '18px', color: '#666', margin: '20px 0' }}>
        Unlock all emails, unlimited searches, and priority support.
      </p>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap' }}>
        ...
        <div style={{ border: '2px solid #2563eb', borderRadius: '12px', padding: '24px', width: '280px' }}>
          <h3 style={{ fontSize: '24px', margin: '0 0 8px' }}>
            Annual <span style={{ background: '#dc2626', color: 'white', fontSize: '12px', padding: '2px 6px', borderRadius: '4px' }}>SAVE 20%</span>
          </h3>
