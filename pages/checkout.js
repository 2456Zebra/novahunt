...
export default function CheckoutPage() {
  ...
  return (
    <div style={{ padding: '60px 20px', fontFamily: 'system-ui, sans-serif', textAlign: 'center', minHeight: '80vh' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: 50, flexWrap: 'wrap' }}>
        {plans.map((plan) => (
          ...
          >
            ...
            <p style={{ fontSize: 40, fontWeight: 'bold' }}>{plan.price}<span style={{ fontSize: 20 }}>/mo</span></p>
            <button
