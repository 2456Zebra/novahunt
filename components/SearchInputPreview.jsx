 ...
 * SearchInputPreview
 *
 * Lightweight preview-only search input.
 * - Isolated: does NOT modify or replace the existing SearchClient component.
 * - Calls /api/search-contacts and falls back to /api/search-contacts-mock.
